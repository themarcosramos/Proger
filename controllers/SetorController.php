...
class SetorController extends Controller
{
    ...
    public function actionDelete($id)
    {
        if(\Yii::$app->user->can('gerenciamento-cadastros-basicos')){
            ...
            if($registroAcionado->getCursoProgers()->exists()||$registroAcionado->getProgramaProgers()->exists()||$registroAcionado->getProjetoProgers()->exists()||$registroAcionado->getIntegrantes()->exists()){//Verifica se existe associações ao registro atual
