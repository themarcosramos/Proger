...
use app\models\search\tipoFuncaoSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * TipoFuncaoController implements the CRUD actions for tipoFuncao model.
 */
class TipoFuncaoController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all tipoFuncao models.
     * @return mixed
     */
    public function actionIndex()
    {
    if(\Yii::$app->user->can('gerenciamento-cadastros-basicos')){
        $searchModel = new tipoFuncaoSearch();
    ...
    /**
     * Displays a single tipoFuncao model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new tipoFuncao model.
    ...
    /**
     * Updates an existing tipoFuncao model.
    ...
    /**
     * Deletes an existing tipoFuncao model.
    ...
    /**
     * Finds the tipoFuncao model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return tipoFuncao the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = tipoFuncao::findOne($id)) !== null) {
            return $model;
        } else {
