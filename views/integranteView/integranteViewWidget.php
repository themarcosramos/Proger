<?php
namespace app\views\integranteView;
...
class integranteViewWidget  extends Widget{
        ...
        switch ($this->type) {
            case 'form':
                if (isset($this->integrante))
                   return $this->render('integrante-formView', ['model'=>$this->integrante, 'cpf'=>$this->cpf, 'controller'=>$this->controller, 'update'=>$this->updateIntegrante, 'idmodel'=>$this->idmodel, 'novo'=>$this->novo]);
